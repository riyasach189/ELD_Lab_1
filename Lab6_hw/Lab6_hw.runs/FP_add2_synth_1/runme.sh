...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/ELD_Lab/Lab6_hw/Lab6_hw.runs/FP_add2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FP_add2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FP_add2.tcl
