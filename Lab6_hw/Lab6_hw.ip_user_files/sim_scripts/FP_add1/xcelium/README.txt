...
#
# Generated by export_simulation on Thu Oct 12 09:52:49 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './FP_add1.sh' script.

./FP_add1.sh -reset_run
...
./FP_add1.sh -noclean_files

For more information on the script, please type './FP_add1.sh -help'.
