...
#
# Generated by export_simulation on Thu Oct 12 09:53:26 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './FP_add2.sh' script.

./FP_add2.sh -reset_run
...
./FP_add2.sh -noclean_files

For more information on the script, please type './FP_add2.sh -help'.
