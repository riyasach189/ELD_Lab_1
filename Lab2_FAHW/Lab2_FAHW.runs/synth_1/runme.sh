...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/College/Semester_3/Embedded_Logic_Design/Labs/Lab2_FAHW/Lab2_FAHW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log subtractorHW.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source subtractorHW.tcl
