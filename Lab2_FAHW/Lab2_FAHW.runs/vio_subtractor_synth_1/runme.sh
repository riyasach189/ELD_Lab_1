...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/College/Semester_3/Embedded_Logic_Design/Labs/Lab2_FAHW/Lab2_FAHW.runs/vio_subtractor_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_subtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_subtractor.tcl
