...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/College/Semester_3/Embedded_Logic_Design/Labs/Lab2_FAHW/Lab2_FAHW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log subtractorHW.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source subtractorHW.tcl -notrace
