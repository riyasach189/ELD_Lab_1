...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/ELD_Lab/Lab2_FAHW_Att2/Lab2_FAHW_Att2.runs/vio_sub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_sub.tcl
