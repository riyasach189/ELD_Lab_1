...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/ELD_Lab/multiplier/multiplier.runs/vio_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_mult.tcl
