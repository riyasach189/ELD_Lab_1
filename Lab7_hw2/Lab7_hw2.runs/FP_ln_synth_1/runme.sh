...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/ELD_Lab/Lab7_hw2/Lab7_hw2.runs/FP_ln_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FP_ln.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FP_ln.tcl
