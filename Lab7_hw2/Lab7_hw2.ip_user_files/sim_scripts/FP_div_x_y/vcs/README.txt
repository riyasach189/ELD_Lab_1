...
#
# Generated by export_simulation on Tue Oct 17 15:16:35 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './FP_div_x_y.sh' script.

./FP_div_x_y.sh -reset_run
...
./FP_div_x_y.sh -noclean_files

For more information on the script, please type './FP_div_x_y.sh -help'.
