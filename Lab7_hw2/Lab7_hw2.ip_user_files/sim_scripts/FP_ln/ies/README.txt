...
#
# Generated by export_simulation on Tue Oct 17 15:12:45 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './FP_ln.sh' script.
...
./FP_ln.sh -noclean_files

For more information on the script, please type './FP_ln.sh -help'.
