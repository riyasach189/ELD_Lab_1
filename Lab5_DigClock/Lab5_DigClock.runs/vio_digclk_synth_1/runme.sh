...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/ELD_Lab/Lab5_DigClock/Lab5_DigClock.runs/vio_digclk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_digclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_digclk.tcl
