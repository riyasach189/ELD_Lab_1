...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/ELD_Lab/Lab5_DigClock/Lab5_DigClock.runs/clk_div_to_8M_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_div_to_8M.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_div_to_8M.tcl
