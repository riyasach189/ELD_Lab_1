...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/ELD_Lab/Lab4_SequenceDetector/Lab4_SequenceDetector.runs/vio_fsm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_fsm.tcl
