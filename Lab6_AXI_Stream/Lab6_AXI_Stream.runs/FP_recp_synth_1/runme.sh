...
HD_PWD='C:/Users/Riya_Sachdeva/Desktop/ELD_Lab/Lab6_AXI_Stream/Lab6_AXI_Stream.runs/FP_recp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FP_recp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FP_recp.tcl
